...
# E-Hailing Financial Calculator Bootstrap Setup
#
...
Write-Host ""
Write-Host "E-Hailing Financial Calculator Bootstrap Setup" -ForegroundColor Cyan
...
Write-Host "  1. Serve the site (:8118):   just start   (foreground: just serve)" -ForegroundColor Gray
Write-Host "  2. Open it in the browser:       just open" -ForegroundColor Gray
